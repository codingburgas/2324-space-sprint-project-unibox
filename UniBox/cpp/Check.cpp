...
std::vector <bool> black_hole_disappear = {0,0,0,0,0,0,0,0,0}; // checkers if a planet needs to disappear
std::vector <bool> draw_on_orbit = {0,0,0,0,0,0,0,0}; // checkers if pluton needs to be in the program
